...
public record StatusCell(LocalDateTime localDateTime) implements Cell {
  ...
  private enum TimeStatus {
    OK(Integer.MIN_VALUE, 2000, TextColor.Factory.fromString("#10A010")), LATE(
        2000,
        5000,
        TextColor.Factory.fromString("#FBA465")
    ), LATER(5000, 10000, TextColor.Factory.fromString("#EE3E38")), MISSING(
        10000,
        20000,
        TextColor.Factory.fromString("#AAAAAA")
