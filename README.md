...
<dependency>
    ...
    <version>2.7.1m-SNAPSHOT</version>
</dependency>
```
...
```shell
java -jar io.github.ericmedvet.jgea.experimenter/target/jgea.experimenter-2.7.1m-SNAPSHOT-jar-with-dependencies.jar -e sr-comparison
```
